...
//0xO1,0x02,0x03,0x04 is Data Channel,0x67,0x68,0x01,0x00 is Data Type
static uint8_t opencml[4]={0x03,0x00,0x64,0xFF};
static uint8_t closecml[4]={0x03,0x00,0x00,0xFF}; 
//the payload of the cayenne or ttn downlink
